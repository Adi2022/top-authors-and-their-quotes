...
const navigation = [
  ...
  { name: "Motivational Speaker", path: "/motivation", current: false },
  { name: "Contact", path: "/contact", current: false },
  { name: "Feedback", path: "/feedback", current: false },
];
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-shrink-0 items-center">
                  <img
                    ...
                    src="https://cdna.artstation.com/p/assets/images/images/011/894/992/large/jerry-ubah-logo.jpg?1531974604"
                    alt="Your Company"
                  />
                  <img
